...
public partial class StartupService : IHostedService
{
    ...
    [LoggerMessage(EventId = 11015, Level = LogLevel.Information, Message = "🛡️ Initiating startup sequence"
)]
    private partial void LogStartupSequenceInitiated();

    [LoggerMessage(EventId = 11016, Level = LogLevel.Information, Message = "[OK] All startup validations completed successfully"
)]
    private partial void LogStartupValidationsCompleted();

    [LoggerMessage(EventId = 11017, Level = LogLevel.Critical, Message = "[CRITICAL] STARTUP VALIDATION FAILED: {ErrorMessage}. Application will terminate → prevent undefined behavior."
)]
    private partial void LogStartupValidationFailed(string errorMessage);

    [LoggerMessage(EventId = 11018, Level = LogLevel.Critical, Message = "[CRITICAL] STARTUP VALIDATION FAILED: {ErrorMessage}. Application will terminate → prevent undefined behavior."
)]
    private partial void LogStartupValidationFailedWithException(string errorMessage, Exception exception);

    [LoggerMessage(EventId = 11019, Level = LogLevel.Critical, Message = "[CRITICAL] UNEXPECTED STARTUP FAILURE: {ErrorMessage}. Application will terminate."
)]
    private partial void LogUnexpectedStartupFailure(string errorMessage);

    [LoggerMessage(EventId = 11020, Level = LogLevel.Critical, Message = "[CRITICAL] UNEXPECTED STARTUP FAILURE: {ErrorMessage}. Application will terminate."
)]
    private partial void LogUnexpectedStartupFailureWithException(string errorMessage, Exception exception);

    [LoggerMessage(EventId = 11021, Level = LogLevel.Information, Message = "🛡️ Graceful shutdown initiated"
)]
    private partial void LogGracefulShutdownInitiated();

    [LoggerMessage(EventId = 11022, Level = LogLevel.Information, Message = "{ValidationStep}: Attempt {AttemptNumber}/{MaxAttempts}"
)]
    private partial void LogValidationAttempt(string validationStep, int attemptNumber, int maxAttempts);

    [LoggerMessage(EventId = 11023, Level = LogLevel.Information, Message = "{ValidationStep}: Attempt {AttemptNumber}/{MaxAttempts}"
)]
    ...
    [LoggerMessage(EventId = 11024, Level = LogLevel.Warning, Message = "[WARNING] {ValidationStep} failed (attempt {AttemptNumber}/{MaxAttempts}): {ErrorMessage}"
)]
    ...
    [LoggerMessage(EventId = 11025, Level = LogLevel.Warning, Message = "[WARNING] {ValidationStep} failed (attempt {AttemptNumber}/{MaxAttempts}): {ErrorMessage}"
)]
    ...
    [LoggerMessage(EventId = 11026, Level = LogLevel.Error, Message = "[ERROR] {ValidationStep} failed after {MaxAttempts} attempts: {ErrorMessage}"
)]
    private partial void LogValidationFailedFinal(string validationStep, int maxAttempts, string errorMessage);

    [LoggerMessage(EventId = 11027, Level = LogLevel.Error, Message = "[ERROR] {ValidationStep} failed after {MaxAttempts} attempts: {ErrorMessage}"
)]
    ...
    [LoggerMessage(EventId = 11028, Level = LogLevel.Warning, Message = "Port {Port} ({ServiceName}) is already in use by another process"
)]
    private partial void LogPortInUse(int port, string serviceName);

    [LoggerMessage(EventId = 11029, Level = LogLevel.Information, Message = "Waiting {DelaySeconds}s before retry..."
)]
    private partial void LogRetryDelay(int delaySeconds);

    [LoggerMessage(EventId = 11030, Level = LogLevel.Debug, Message = "[OK] Port {Port} ({ServiceName}) is available"
)]
    private partial void LogPortAvailable(int port, string serviceName);

    [LoggerMessage(EventId = 11031, Level = LogLevel.Error, Message = "[ERROR] Failed → check port {Port} ({ServiceName}): {ErrorMessage}"
)]
    private partial void LogPortCheckFailed(int port, string serviceName, string errorMessage);

    [LoggerMessage(EventId = 11032, Level = LogLevel.Error, Message = "[ERROR] Failed → check port {Port} ({ServiceName}): {ErrorMessage}"
)]
    ...
    [LoggerMessage(EventId = 11033, Level = LogLevel.Warning, Message = "{ServiceName} is not reachable ({Address}:{Port}): {ErrorMessage}"
)]
    private partial void LogServiceNotReachable(string serviceName, string address, int port, string errorMessage);

    [LoggerMessage(EventId = 11034, Level = LogLevel.Warning, Message = "{ServiceName} is not reachable ({Address}): {ErrorMessage}"
)]
    private partial void LogServiceNotReachableNoPort(string serviceName, string address, string errorMessage);

    [LoggerMessage(EventId = 11035, Level = LogLevel.Debug, Message = "[OK] {ServiceName} is reachable ({Address}:{Port})"
)]
    private partial void LogServiceReachable(string serviceName, string address, int port);

    [LoggerMessage(EventId = 11036, Level = LogLevel.Warning, Message = "[WARNING] Failed → check connectivity → {ServiceName} ({Address}:{Port}): {ErrorMessage}"
)]
    private partial void LogConnectivityCheckFailed(string serviceName, string address, int port, string errorMessage);

    [LoggerMessage(EventId = 11037, Level = LogLevel.Warning, Message = "[WARNING] Failed → check connectivity → {ServiceName} ({Address}:{Port}): {ErrorMessage}"
)]
    ...
    [LoggerMessage(EventId = 11038, Level = LogLevel.Information, Message = "📁 Created required directory: {Directory}"
)]
    private partial void LogDirectoryCreated(string directory);

    [LoggerMessage(EventId = 11039, Level = LogLevel.Information, Message = "🧪 Directory validation skipped in test environment"
)]
    private partial void LogDirectoryValidationSkipped();

    [LoggerMessage(EventId = 11040, Level = LogLevel.Debug, Message = "[OK] Directory {Directory} is accessible and writable"
)]
    private partial void LogDirectoryAccessible(string directory);

    [LoggerMessage(EventId = 11041, Level = LogLevel.Error, Message = "[ERROR] Directory {Directory} is not accessible or writable"
)]
    private partial void LogDirectoryNotAccessible(string directory, Exception exception);

    [LoggerMessage(EventId = 11042, Level = LogLevel.Error, Message = "[ERROR] Directory {Directory} is not accessible or writable: {ErrorMessage}"
)]
    private partial void LogDirectoryNotAccessibleWithMessage(string directory, string errorMessage);

    [LoggerMessage(EventId = 11043, Level = LogLevel.Critical, Message = "[CRITICAL] STARTUP FAILURE ANALYSIS:"
)]
    private partial void LogStartupFailureAnalysisHeader();

    [LoggerMessage(EventId = 11044, Level = LogLevel.Critical, Message = "Validation Step: {ValidationStep}"
)]
    private partial void LogFailureValidationStep(string validationStep);

    [LoggerMessage(EventId = 11045, Level = LogLevel.Critical, Message = "Attempts Made: {Attempts}"
)]
    private partial void LogFailureAttempts(int attempts);

    [LoggerMessage(EventId = 11046, Level = LogLevel.Critical, Message = "Final Error: {ErrorMessage}"
)]
    private partial void LogFailureFinalError(string errorMessage);

    [LoggerMessage(EventId = 11047, Level = LogLevel.Critical, Message = "Timestamp: {Timestamp:yyyy-MM-dd HH:mm:ss.fff} UTC"
)]
    private partial void LogFailureTimestamp(DateTime timestamp);

    [LoggerMessage(EventId = 11048, Level = LogLevel.Critical, Message = "Machine: {MachineName}"
)]
    private partial void LogFailureMachine(string machineName);

    [LoggerMessage(EventId = 11049, Level = LogLevel.Critical, Message = "Process ID: {ProcessId}"
)]
    private partial void LogFailureProcessId(int processId);

    [LoggerMessage(EventId = 11050, Level = LogLevel.Critical, Message = "Working Directory: {WorkingDirectory}"
)]
    private partial void LogFailureWorkingDirectory(string workingDirectory);

    [LoggerMessage(EventId = 11051, Level = LogLevel.Critical, Message = "Port Conflicts:"
)]
    private partial void LogFailurePortConflictsHeader();

    [LoggerMessage(EventId = 11052, Level = LogLevel.Critical, Message = "- {Service} on port {Port}: {ConflictDetails}"
)]
    private partial void LogFailurePortConflict(string service, int port, string conflictDetails);

    [LoggerMessage(EventId = 11053, Level = LogLevel.Critical, Message = "Exception Details: {ExceptionDetails}"
)]
    private partial void LogFailureExceptionDetails(string exceptionDetails);

    [LoggerMessage(EventId = 11054, Level = LogLevel.Critical, Message = "[CRITICAL] UNEXPECTED FAILURE ANALYSIS:"
)]
    private partial void LogUnexpectedFailureAnalysisHeader();

    [LoggerMessage(EventId = 11055, Level = LogLevel.Critical, Message = "Exception Type: {ExceptionType}"
)]
    private partial void LogUnexpectedFailureExceptionType(string exceptionType);

    [LoggerMessage(EventId = 11056, Level = LogLevel.Critical, Message = "Error Message: {ErrorMessage}"
)]
    private partial void LogUnexpectedFailureErrorMessage(string errorMessage);

    [LoggerMessage(EventId = 11057, Level = LogLevel.Critical, Message = "Stack Trace: {StackTrace}"
)]
    private partial void LogUnexpectedFailureStackTrace(string stackTrace);

    [LoggerMessage(EventId = 11058, Level = LogLevel.Critical, Message = "Inner Exception {Depth}: {InnerExceptionType} - {InnerMessage}"
)]
    ...
    [LoggerMessage(EventId = 11059, Level = LogLevel.Critical, Message = "CRITICAL STARTUP FAILURE: {ValidationStep} failed after {MaxAttempts} attempts. Application cannot continue safely. Initiating graceful shutdown."
)]
    ...
    [LoggerMessage(EventId = 11060, Level = LogLevel.Critical, Message = "CRITICAL STARTUP FAILURE: {ValidationStep} failed after {MaxAttempts} attempts. Application cannot continue safely. Reason: {ErrorMessage}"
)]
    private partial void LogCriticalStartupFailure(string validationStep, int maxAttempts, string errorMessage);

    [LoggerMessage(EventId = 11061, Level = LogLevel.Critical, Message = "UNEXPECTED CRITICAL FAILURE: Application encountered an unexpected error during startup. Initiating emergency shutdown."
)]
    private partial void LogUnexpectedCriticalFailureWithException(Exception exception);

    [LoggerMessage(EventId = 11062, Level = LogLevel.Critical, Message = "UNEXPECTED CRITICAL FAILURE: {ErrorMessage}. Application cannot continue safely."
)]
    private partial void LogUnexpectedCriticalFailure(string errorMessage);

    [LoggerMessage(EventId = 11063, Level = LogLevel.Information, Message = "{OperationName}: Attempt {Attempt}/{MaxAttempts}"
)]
    private partial void LogOperationAttempt(string operationName, int attempt, int maxAttempts);

    [LoggerMessage(EventId = 11064, Level = LogLevel.Information, Message = "[OK] {OperationName}: Succeeded on attempt {Attempt}"
)]
    private partial void LogOperationSucceededOnRetry(string operationName, int attempt);

    [LoggerMessage(EventId = 11065, Level = LogLevel.Warning, Message = "[WARNING] {OperationName} failed (attempt {Attempt}/{MaxAttempts}): {ErrorMessage}"
)]
    ...
    [LoggerMessage(EventId = 11066, Level = LogLevel.Warning, Message = "[WARNING] {OperationName} failed (attempt {Attempt}/{MaxAttempts}): {ErrorMessage}"
)]
    ...
    [LoggerMessage(EventId = 11067, Level = LogLevel.Error, Message = "[ERROR] {OperationName} failed after {MaxAttempts} attempts: {ErrorMessage}"
)]
    private partial void LogOperationFailedFinal(string operationName, int maxAttempts, string errorMessage);

    [LoggerMessage(EventId = 11068, Level = LogLevel.Error, Message = "[ERROR] {OperationName} failed after {MaxAttempts} attempts: {ErrorMessage}"
)]
    ...
    [LoggerMessage(EventId = 11069, Level = LogLevel.Warning, Message = "[WARNING] {OperationName}: Attempt {Attempt}/{MaxAttempts} failed. Retrying in {DelayMs} ms. Error: {ErrorMessage}"
)]
    ...
    [LoggerMessage(EventId = 11070, Level = LogLevel.Warning, Message = "[WARNING] {OperationName}: Attempt {Attempt}/{MaxAttempts} failed. Retrying in {DelayMs} ms. Error: {ErrorMessage}"
)]
    ...
    [LoggerMessage(EventId = 11071, Level = LogLevel.Error, Message = "[ERROR] {OperationName}: Final attempt {Attempt}/{MaxAttempts} failed. Operation cannot be completed."
)]
    ...
    [LoggerMessage(EventId = 11072, Level = LogLevel.Error, Message = "[ERROR] {OperationName}: Final attempt {Attempt}/{MaxAttempts} failed. Operation cannot be completed. Error: {ErrorType} - {ErrorMessage}"
)]
    ...
    [LoggerMessage(EventId = 11073, Level = LogLevel.Error, Message = "[ERROR] Failed → check port availability for {ServiceName} on port {Port}"
)]
    private partial void LogPortAvailabilityCheckFailedWithException(string serviceName, int port, Exception exception);

    [LoggerMessage(EventId = 11074, Level = LogLevel.Error, Message = "[ERROR] Failed → check port availability for {ServiceName} on port {Port}: {ErrorType} - {ErrorMessage}"
)]
    ...
    [LoggerMessage(EventId = 11075, Level = LogLevel.Warning, Message = "[ERROR] Failed → verify {ServiceName} connectivity ({Address}:{Port})"
)]
    ...
    [LoggerMessage(EventId = 11076, Level = LogLevel.Warning, Message = "[ERROR] Failed → verify {ServiceName} connectivity ({Address}:{Port}): {ErrorMessage}"
)]
    ...
    [LoggerMessage(EventId = 11077, Level = LogLevel.Warning, Message = "Port conflict detected: {ServiceName} port {Port} is in use. {ConflictDetails}"
)]
    private partial void LogPortConflictDetected(string serviceName, int port, string conflictDetails);

    [LoggerMessage(EventId = 11078, Level = LogLevel.Information, Message = "Alternative port found for {ServiceName}: {AlternativePort}"
)]
    private partial void LogAlternativePortFound(string serviceName, int alternativePort);

    [LoggerMessage(EventId = 11079, Level = LogLevel.Warning, Message = "{ServiceName} connectivity check timed out ({Address}:{Port})"
)]
    private partial void LogConnectivityCheckTimedOut(string serviceName, string address, int port);

    [LoggerMessage(EventId = 11080, Level = LogLevel.Debug, Message = "[OK] {ServiceName} connectivity verified ({Address}:{Port})"
)]
