...
public partial class SharedLoggingCommandBehavior<TCommand, TResponse>
{
    ...
    [LoggerMessage(EventId = 14000, Level = LogLevel.Information, Message = "Starting Command {CommandName}"
)]
    private partial void LogStartingCommand(string commandName);

    [LoggerMessage(EventId = 14001, Level = LogLevel.Information, Message = "Completed Command {CommandName} in {ElapsedMilliseconds}ms"
)]
    private partial void LogCompletedCommand(string commandName, long elapsedMilliseconds);

    [LoggerMessage(EventId = 14002, Level = LogLevel.Error, Message = "Command {CommandName} failed after {ElapsedMilliseconds}ms"
)]
...
public partial class SharedLoggingQueryBehavior<TQuery, TResponse>
{
    ...
    [LoggerMessage(EventId = 14003, Level = LogLevel.Information, Message = "Starting Query {QueryName}"
)]
    private partial void LogStartingQuery(string queryName);

    [LoggerMessage(EventId = 14004, Level = LogLevel.Information, Message = "Completed Query {QueryName} in {ElapsedMilliseconds}ms"
)]
    private partial void LogCompletedQuery(string queryName, long elapsedMilliseconds);

    [LoggerMessage(EventId = 14005, Level = LogLevel.Error, Message = "Query {QueryName} failed after {ElapsedMilliseconds}ms"
)]
