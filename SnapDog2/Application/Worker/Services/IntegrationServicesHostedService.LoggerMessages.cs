...
public partial class IntegrationServicesHostedService
{
    ...
    [LoggerMessage(EventId = 14071, Level = LogLevel.Information, Message = "Integration services initialization cancelled"
)]
    private partial void LogIntegrationServicesInitializationCancelled();

    [LoggerMessage(EventId = 14072, Level = LogLevel.Error, Message = "Failed → initialize integration services"
)]
    private partial void LogFailedToInitializeIntegrationServices(Exception ex);

    [LoggerMessage(EventId = 14073, Level = LogLevel.Information, Message = "Stopping integration services..."
)]
    private partial void LogStoppingIntegrationServices();

    [LoggerMessage(EventId = 14074, Level = LogLevel.Information, Message = "Integration services stopped"
)]
