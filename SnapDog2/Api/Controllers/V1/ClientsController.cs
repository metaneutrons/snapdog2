...
public partial class ClientsController(IClientService clientService, IOptions<SnapDogConfiguration> snapDogConfig, ILogger<ClientsController> logger) : ControllerBase
{
    ...
    [LoggerMessage(EventId = 13057, Level = LogLevel.Warning, Message = "Failed → get clients: {ErrorMessage}")]
    private partial void LogFailedToGetClients(string errorMessage);

    [LoggerMessage(EventId = 13058, Level = LogLevel.Warning, Message = "Failed → get client {ClientIndex}: {ErrorMessage}")]
    private partial void LogFailedToGetClient(int clientIndex, string errorMessage);

    [LoggerMessage(EventId = 13059, Level = LogLevel.Warning, Message = "Failed → set client {ClientIndex} volume → {Volume}: {ErrorMessage}")]
    private partial void LogFailedToSetClientVolume(int clientIndex, int volume, string errorMessage);

    [LoggerMessage(EventId = 13060, Level = LogLevel.Warning, Message = "Failed → get client {ClientIndex} volume: {ErrorMessage}")]
    private partial void LogFailedToGetClientVolume(int clientIndex, string errorMessage);

    [LoggerMessage(EventId = 13061, Level = LogLevel.Warning, Message = "Failed → get client {ClientIndex} for volume up: {ErrorMessage}")]
    private partial void LogFailedToGetClientForVolumeUp(int clientIndex, string errorMessage);

    [LoggerMessage(EventId = 13062, Level = LogLevel.Warning, Message = "Failed → increase client {ClientIndex} volume: {ErrorMessage}")]
    private partial void LogFailedToIncreaseClientVolume(int clientIndex, string errorMessage);

    [LoggerMessage(EventId = 13063, Level = LogLevel.Warning, Message = "Failed → get client {ClientIndex} for volume down: {ErrorMessage}")]
    private partial void LogFailedToGetClientForVolumeDown(int clientIndex, string errorMessage);

    [LoggerMessage(EventId = 13064, Level = LogLevel.Warning, Message = "Failed → decrease client {ClientIndex} volume: {ErrorMessage}")]
    private partial void LogFailedToDecreaseClientVolume(int clientIndex, string errorMessage);

    [LoggerMessage(EventId = 13065, Level = LogLevel.Warning, Message = "Failed → set client {ClientIndex} mute → {Muted}: {ErrorMessage}")]
    private partial void LogFailedToSetClientMute(int clientIndex, bool muted, string errorMessage);

    [LoggerMessage(EventId = 13066, Level = LogLevel.Warning, Message = "Failed → get client {ClientIndex} mute state: {ErrorMessage}")]
    private partial void LogFailedToGetClientMuteState(int clientIndex, string errorMessage);

    [LoggerMessage(EventId = 13067, Level = LogLevel.Warning, Message = "Failed → toggle client {ClientIndex} mute: {ErrorMessage}")]
    private partial void LogFailedToToggleClientMute(int clientIndex, string errorMessage);

    [LoggerMessage(EventId = 13068, Level = LogLevel.Warning, Message = "Failed → get client {ClientIndex} after mute toggle: {ErrorMessage}")]
    private partial void LogFailedToGetClientAfterMuteToggle(int clientIndex, string errorMessage);

    [LoggerMessage(EventId = 13069, Level = LogLevel.Warning, Message = "Failed → set client {ClientIndex} latency → {Latency}ms: {ErrorMessage}")]
    private partial void LogFailedToSetClientLatency(int clientIndex, int latency, string errorMessage);

    [LoggerMessage(EventId = 13070, Level = LogLevel.Warning, Message = "Failed → get client {ClientIndex} latency: {ErrorMessage}")]
    private partial void LogFailedToGetClientLatency(int clientIndex, string errorMessage);

    [LoggerMessage(EventId = 13071, Level = LogLevel.Warning, Message = "Failed → assign client {ClientIndex} → zone {ZoneIndex}: {ErrorMessage}")]
    private partial void LogFailedToAssignClientToZone(int clientIndex, int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 13072, Level = LogLevel.Warning, Message = "Failed → get client {ClientIndex} zone assignment: {ErrorMessage}")]
    private partial void LogFailedToGetClientZoneAssignment(int clientIndex, string errorMessage);

    [LoggerMessage(EventId = 13073, Level = LogLevel.Information, Message = "Setting client {ClientIndex} name → '{Name}'")]
    private partial void LogSettingClientName(int clientIndex, string name);

    [LoggerMessage(EventId = 13074, Level = LogLevel.Warning, Message = "Failed → set client {ClientIndex} name → '{Name}': {ErrorMessage}")]
    private partial void LogFailedToSetClientName(int clientIndex, string name, string errorMessage);

    [LoggerMessage(EventId = 13075, Level = LogLevel.Warning, Message = "Failed → get client {ClientIndex} connection status: {ErrorMessage}")]
    private partial void LogFailedToGetClientConnectionStatus(int clientIndex, string errorMessage);

    [LoggerMessage(EventId = 13076, Level = LogLevel.Warning, Message = "Failed → get client {ClientIndex} name: {ErrorMessage}")]
