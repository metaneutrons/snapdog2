...
public partial class ZonesController(IMediator mediator, ILogger<ZonesController> logger) : ControllerBase
{
    ...
    [LoggerMessage(EventId = 113250, Level = LogLevel.Warning, Message = "Failed to get zones: {ErrorMessage}"
)]
    private partial void LogFailedToGetZones(string errorMessage);

    [LoggerMessage(EventId = 113251, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex}: {ErrorMessage}"
)]
    private partial void LogFailedToGetZone(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113252, Level = LogLevel.Warning, Message = "Failed to set zone {ZoneIndex} volume to {Volume}: {ErrorMessage}"
)]
    private partial void LogFailedToSetZoneVolume(int zoneIndex, int volume, string errorMessage);

    [LoggerMessage(EventId = 113253, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex} volume: {ErrorMessage}"
)]
    private partial void LogFailedToGetZoneVolume(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113254, Level = LogLevel.Warning, Message = "Failed to increase zone {ZoneIndex} volume: {ErrorMessage}"
)]
    private partial void LogFailedToIncreaseZoneVolume(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113255, Level = LogLevel.Warning, Message = "Failed to decrease zone {ZoneIndex} volume: {ErrorMessage}"
)]
    private partial void LogFailedToDecreaseZoneVolume(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113256, Level = LogLevel.Warning, Message = "Failed to set zone {ZoneIndex} mute to {Muted}: {ErrorMessage}"
)]
    private partial void LogFailedToSetZoneMute(int zoneIndex, bool muted, string errorMessage);

    [LoggerMessage(EventId = 113257, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex} mute state: {ErrorMessage}"
)]
    private partial void LogFailedToGetZoneMuteState(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113258, Level = LogLevel.Warning, Message = "Failed to toggle zone {ZoneIndex} mute: {ErrorMessage}"
)]
    private partial void LogFailedToToggleZoneMute(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113259, Level = LogLevel.Warning, Message = "Failed to play zone {ZoneIndex}: {ErrorMessage}"
)]
    private partial void LogFailedToPlayZone(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113260, Level = LogLevel.Warning, Message = "Failed to pause zone {ZoneIndex}: {ErrorMessage}"
)]
    private partial void LogFailedToPauseZone(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113261, Level = LogLevel.Warning, Message = "Failed to stop zone {ZoneIndex}: {ErrorMessage}"
)]
    private partial void LogFailedToStopZone(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113262, Level = LogLevel.Warning, Message = "Failed to set zone {ZoneIndex} playlist to {PlaylistIndex}: {ErrorMessage}"
)]
    ...
    [LoggerMessage(EventId = 113263, Level = LogLevel.Warning, Message = "Failed to set zone {ZoneIndex} track to {TrackIndex}: {ErrorMessage}"
)]
    ...
    [LoggerMessage(EventId = 113264, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex} track repeat: {ErrorMessage}"
)]
    private partial void LogFailedToGetZoneTrackRepeat(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113265, Level = LogLevel.Warning, Message = "Failed to set zone {ZoneIndex} track repeat to {Enabled}: {ErrorMessage}"
)]
    private partial void LogFailedToSetZoneTrackRepeat(int zoneIndex, bool enabled, string errorMessage);

    [LoggerMessage(EventId = 113266, Level = LogLevel.Warning, Message = "Failed to toggle zone {ZoneIndex} track repeat: {ErrorMessage}"
)]
    private partial void LogFailedToToggleZoneTrackRepeat(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113267, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex} playlist repeat: {ErrorMessage}"
)]
    private partial void LogFailedToGetZonePlaylistRepeat(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113268, Level = LogLevel.Warning, Message = "Failed to set zone {ZoneIndex} playlist repeat to {Enabled}: {ErrorMessage}"
)]
    private partial void LogFailedToSetZonePlaylistRepeat(int zoneIndex, bool enabled, string errorMessage);

    [LoggerMessage(EventId = 113269, Level = LogLevel.Warning, Message = "Failed to toggle zone {ZoneIndex} playlist repeat: {ErrorMessage}"
)]
    private partial void LogFailedToToggleZonePlaylistRepeat(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113270, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex} playlist shuffle: {ErrorMessage}"
)]
    private partial void LogFailedToGetZonePlaylistShuffle(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113271, Level = LogLevel.Warning, Message = "Failed to set zone {ZoneIndex} playlist shuffle to {Enabled}: {ErrorMessage}"
)]
    private partial void LogFailedToSetZonePlaylistShuffle(int zoneIndex, bool enabled, string errorMessage);

    [LoggerMessage(EventId = 113272, Level = LogLevel.Warning, Message = "Failed to toggle zone {ZoneIndex} playlist shuffle: {ErrorMessage}"
)]
    ...
    [LoggerMessage(EventId = 113273, Level = LogLevel.Warning, Message = "Failed to skip zone {ZoneIndex} to next track: {ErrorMessage}"
)]
    private partial void LogFailedToSkipToNextTrack(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113274, Level = LogLevel.Warning, Message = "Failed to skip zone {ZoneIndex} to previous track: {ErrorMessage}"
)]
    private partial void LogFailedToSkipToPreviousTrack(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113275, Level = LogLevel.Warning, Message = "Failed to switch zone {ZoneIndex} to next playlist: {ErrorMessage}"
)]
    private partial void LogFailedToSwitchToNextPlaylist(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113276, Level = LogLevel.Warning, Message = "Failed to switch zone {ZoneIndex} to previous playlist: {ErrorMessage}"
)]
    private partial void LogFailedToSwitchToPreviousPlaylist(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113277, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex} track index: {ErrorMessage}"
)]
    private partial void LogFailedToGetZoneTrackIndex(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113278, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex} playlist index: {ErrorMessage}"
)]
    private partial void LogFailedToGetZonePlaylistIndex(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113288, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex} playlist info: {ErrorMessage}"
)]
    private partial void LogFailedToGetZonePlaylistInfo(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113280, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex} track metadata: {ErrorMessage}"
)]
    private partial void LogFailedToGetZoneTrackMetadata(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113281, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex} track playing status: {ErrorMessage}"
)]
    private partial void LogFailedToGetZoneTrackPlaying(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113282, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex} track position: {ErrorMessage}"
)]
    private partial void LogFailedToGetZoneTrackPosition(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113283, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex} track progress: {ErrorMessage}"
)]
    private partial void LogFailedToGetZoneTrackProgress(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113284, Level = LogLevel.Warning, Message = "Failed to set zone {ZoneIndex} track position to {PositionMs}ms: {ErrorMessage}"
)]
    private partial void LogFailedToSetZoneTrackPosition(int zoneIndex, long positionMs, string errorMessage);

    [LoggerMessage(EventId = 113285, Level = LogLevel.Warning, Message = "Failed to set zone {ZoneIndex} track progress to {Progress:P1}: {ErrorMessage}"
)]
    private partial void LogFailedToSetZoneTrackProgress(int zoneIndex, float progress, string errorMessage);

    [LoggerMessage(EventId = 113286, Level = LogLevel.Warning, Message = "Failed to play track {TrackIndex} for zone {ZoneIndex}: {ErrorMessage}"
)]
    private partial void LogFailedToPlayTrackByIndex(int zoneIndex, int trackIndex, string errorMessage);

    [LoggerMessage(EventId = 113287, Level = LogLevel.Warning, Message = "Failed to play URL '{Url}' for zone {ZoneIndex}: {ErrorMessage}"
)]
    private partial void LogFailedToPlayUrl(int zoneIndex, string url, string errorMessage);

    [LoggerMessage(EventId = 113288, Level = LogLevel.Warning, Message = "Failed to play track {TrackIndex} from playlist {PlaylistIndex} for zone {ZoneIndex}: {ErrorMessage}"
)]
    private partial void LogFailedToPlayTrackFromPlaylist(int zoneIndex, int playlistIndex, int trackIndex, string errorMessage);

    [LoggerMessage(EventId = 113290, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex} track title: {ErrorMessage}"
)]
    private partial void LogFailedToGetZoneTrackTitle(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113290, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex} track artist: {ErrorMessage}"
)]
    private partial void LogFailedToGetZoneTrackArtist(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113291, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex} track album: {ErrorMessage}"
)]
    private partial void LogFailedToGetZoneTrackAlbum(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113292, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex} track cover: {ErrorMessage}"
)]
    private partial void LogFailedToGetZoneTrackCover(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113293, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex} track duration: {ErrorMessage}"
)]
    ...
    [LoggerMessage(EventId = 113294, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex} name: {ErrorMessage}"
)]
    ...
    [LoggerMessage(EventId = 113295, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex} playback state: {ErrorMessage}"
)]
    private partial void LogFailedToGetPlaybackState(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113296, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex} playlist name: {ErrorMessage}"
)]
    private partial void LogFailedToGetPlaylistName(int zoneIndex, string errorMessage);

    [LoggerMessage(EventId = 113297, Level = LogLevel.Warning, Message = "Failed to get zone {ZoneIndex} playlist count: {ErrorMessage}"
)]
    ...
    [LoggerMessage(EventId = 113298, Level = LogLevel.Warning, Message = "Failed to execute control command '{Command}' on zone {ZoneIndex}: {ErrorMessage}"
)]
