...
) : ControllerBase
{
    ...
    public async Task<ActionResult<ApiResponse<SystemStatus>>> GetSystemStatus(CancellationToken cancellationToken)
    {
        try
        {
            ...
            var handler =
                this._serviceProvider.GetService<GetSystemStatusQueryHandler>();
            if (handler == null)
            {
    ...
    )
    {
        try
        {
            ...
            var handler =
                this._serviceProvider.GetService<GetErrorStatusQueryHandler>();
            if (handler == null)
            {
    ...
    public async Task<ActionResult<ApiResponse<VersionDetails>>> GetVersion(CancellationToken cancellationToken)
    {
        try
        {
            ...
            var handler =
                this._serviceProvider.GetService<GetVersionInfoQueryHandler>();
            if (handler == null)
            {
    ...
    public async Task<ActionResult<ApiResponse<ServerStats>>> GetServerStats(CancellationToken cancellationToken)
    {
        try
        {
            ...
            var handler =
                this._serviceProvider.GetService<GetServerStatsQueryHandler>();
            if (handler == null)
            {
