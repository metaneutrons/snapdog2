...
public partial class KnxCommandReceiver : IHostedService
{
    ...
    [LoggerMessage(EventId = 15144, Level = LogLevel.Information, Message = "KNX command receiver started")]
    private partial void LogKnxCommandReceiverStarted();

    [LoggerMessage(EventId = 15145, Level = LogLevel.Warning, Message = "KNX not enabled, command receiver disabled")]
    private partial void LogKnxCommandReceiverDisabled();

    [LoggerMessage(EventId = 15146, Level = LogLevel.Debug, Message = "KNX command {CommandId} handled for entity {EntityIndex}: {Success}")]
