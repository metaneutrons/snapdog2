...
public sealed partial class NotificationQueue : INotificationQueue
{
    ...
    [LoggerMessage(EventId = 17016, Level = LogLevel.Debug, Message = "Enqueued notification {EventType} for zone {ZoneIndex}"
)]
    private partial void LogZoneNotificationEnqueued(string eventType, int zoneIndex);

    [LoggerMessage(EventId = 17017, Level = LogLevel.Debug, Message = "Enqueued notification {EventType} for client {ClientIndex}"
)]
    private partial void LogClientNotificationEnqueued(string eventType, string clientIndex);

    [LoggerMessage(EventId = 17018, Level = LogLevel.Debug, Message = "Enqueued notification {EventType} for global system"
)]
