...
public partial class ZoneGroupingBackgroundService : BackgroundService
{
    ...
    [LoggerMessage(EventId = 14186, Level = LogLevel.Information, Message = "Zone grouping service starting with interval {IntervalMs}ms"
)]
    private partial void LogServiceStarting(double intervalMs);

    [LoggerMessage(EventId = 14187, Level = LogLevel.Information, Message = "Zone grouping service stopping"
)]
    private partial void LogServiceStopping();

    [LoggerMessage(EventId = 14188, Level = LogLevel.Error, Message = "Error during periodic zone grouping check"
)]
    private partial void LogPeriodicCheckError(Exception ex);

    [LoggerMessage(EventId = 14189, Level = LogLevel.Debug, Message = "Zone grouping check completed successfully"
)]
    private partial void LogCheckCompleted();

    [LoggerMessage(EventId = 14190, Level = LogLevel.Warning, Message = "Zone grouping check failed"
)]
