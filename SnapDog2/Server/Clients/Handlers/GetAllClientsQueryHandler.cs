    ...
    : IQueryHandler<GetAllClientsQuery, Result<List<ClientState>>>
{
    ...
    [LoggerMessage(EventId = 112300, Level = LogLevel.Information, Message = "Handling GetAllClientsQuery"
)]
    private partial void LogHandling();

    [LoggerMessage(EventId = 112301, Level = LogLevel.Error, Message = "Error retrieving all clients: {ErrorMessage}"
)]
