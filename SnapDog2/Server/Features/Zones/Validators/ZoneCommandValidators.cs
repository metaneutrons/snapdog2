...
public class TogglePlaylistShuffleCommandValidator : BaseZoneCommandValidator<TogglePlaylistShuffleCommand>
{
    ...
    protected override SnapDog2.Core.Enums.CommandSource GetSource(TogglePlaylistShuffleCommand command) => command.Source;
}
...
public class TogglePlaylistRepeatCommandValidator : BaseZoneCommandValidator<TogglePlaylistRepeatCommand>
{
    ...
    protected override SnapDog2.Core.Enums.CommandSource GetSource(TogglePlaylistRepeatCommand command) => command.Source;
}
