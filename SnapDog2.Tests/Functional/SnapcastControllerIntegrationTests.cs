...
public class SnapcastControllerIntegrationTests : ApiTestBase
{
    public SnapcastControllerIntegrationTests(TestWebApplicationFactory<Program> factory) : base(factory)
    {
    }
