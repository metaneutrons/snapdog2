...
### 25.1.1. Docker Deployment (Recommended)
...
### 25.1.3. Bare Metal / Virtual Machine Deployment
...
## 25.3. Operational Procedures

### 25.3.1. Deployment/Update Process (Docker Compose Example)
...
## 25.4. Security Considerations

### 25.4.1. Network Security
...
### 25.4.2. Authentication and Authorization
