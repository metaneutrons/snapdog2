...
## 27.1. Container Architecture Overview
...
## 27.2. `snapserver` Container Customization
...
## 27.3. `snapdog` Container (`/docker/snapdog/Dockerfile`)
...
## 27.4. Docker Compose Configuration (Production Example)
...
## 27.6. Environment Variables for Production
