...
## 28.1. Container Architecture Overview
...
## 28.2. `snapserver` Container Customization
...
## 28.3. `snapdog` Container (`/docker/snapdog/Dockerfile`)
...
## 28.4. Docker Compose Configuration (Production Example)
...
## 28.6. Environment Variables for Production
