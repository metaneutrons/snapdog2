# 11. Infrastructure Services Implementation
...
### 11.1.2. `SnapcastStateRepository`
...
## 11.2. KNX Integration (`/Infrastructure/Knx/KnxService.cs`)
...
## 11.3. MQTT Integration (`/Infrastructure/Mqtt/MqttService.cs`)
