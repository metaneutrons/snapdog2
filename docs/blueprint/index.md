...
- [25.2.4 Developer Experience](22-dry-transformation-architecture.md#2524-developer-experience)
...
- [25.3.2 CommandIdAttribute](22-dry-transformation-architecture.md#2532-commandidattribute)
- [25.4 Implementation Categories](22-dry-transformation-architecture.md#254-implementation-categories)
- [25.4.1 Notification System (19 Classes)](22-dry-transformation-architecture.md#2541-notification-system-19-classes)
- [25.4.1.1 Client Notifications (6 Classes)](22-dry-transformation-architecture.md#25411-client-notifications-6-classes)
- [25.4.1.2 Zone Notifications (8 Classes)](22-dry-transformation-architecture.md#25412-zone-notifications-8-classes)
- [25.4.1.3 Global Notifications (4 Classes)](22-dry-transformation-architecture.md#25413-global-notifications-4-classes)
- [25.4.1.4 Generic Infrastructure (1 Class)](22-dry-transformation-architecture.md#25414-generic-infrastructure-1-class)
- [25.4.2 Command System (22 Classes)](22-dry-transformation-architecture.md#2542-command-system-22-classes)
- [25.4.2.1 Client Commands (3 Classes)](22-dry-transformation-architecture.md#25421-client-commands-3-classes)
- [25.4.2.2 Zone Playback Commands (3 Classes)](22-dry-transformation-architecture.md#25422-zone-playback-commands-3-classes)
- [25.4.2.3 Zone Volume Commands (4 Classes)](22-dry-transformation-architecture.md#25423-zone-volume-commands-4-classes)
- [25.4.2.4 Zone Track Commands (5 Classes)](22-dry-transformation-architecture.md#25424-zone-track-commands-5-classes)
- [25.4.2.5 Zone Playlist Commands (7 Classes)](22-dry-transformation-architecture.md#25425-zone-playlist-commands-7-classes)
- [25.5 Integration Patterns](22-dry-transformation-architecture.md#255-integration-patterns)
- [25.5.1 Notification Handler Pattern](22-dry-transformation-architecture.md#2551-notification-handler-pattern)
- [25.5.2 Command Processing Pattern](22-dry-transformation-architecture.md#2552-command-processing-pattern)
- [25.6 Quality Assurance](22-dry-transformation-architecture.md#256-quality-assurance)
- [25.6.1 Compile-Time Validation](22-dry-transformation-architecture.md#2561-compile-time-validation)
- [25.6.2 Runtime Validation](22-dry-transformation-architecture.md#2562-runtime-validation)
- [25.6.3 Refactoring Safety](22-dry-transformation-architecture.md#2563-refactoring-safety)
- [25.7 Blueprint Reference System](22-dry-transformation-architecture.md#257-blueprint-reference-system)
- [25.7.1 Reference Format](22-dry-transformation-architecture.md#2571-reference-format)
- [25.7.2 Category Mapping](22-dry-transformation-architecture.md#2572-category-mapping)
- [25.8 Benefits and Outcomes](22-dry-transformation-architecture.md#258-benefits-and-outcomes)
- [25.8.1 Code Quality Metrics](22-dry-transformation-architecture.md#2581-code-quality-metrics)
- [25.8.2 Developer Experience](22-dry-transformation-architecture.md#2582-developer-experience)
- [25.8.3 Maintainability](22-dry-transformation-architecture.md#2583-maintainability)
...
- [25.9.3 Validation Enhancements](22-dry-transformation-architecture.md#2593-validation-enhancements)
- [25.10 Enhanced StatusId System Architecture](22-dry-transformation-architecture.md#2510-enhanced-statusid-system-architecture)
- [25.10.1 Multi-Layered DRY Approach](22-dry-transformation-architecture.md#25101-multi-layered-dry-approach)
- [25.10.2 StatusIdRegistry Implementation](22-dry-transformation-architecture.md#25102-statusidregistry-implementation)
- [25.10.3 StatusIds Constants Class](22-dry-transformation-architecture.md#25103-statusids-constants-class)
- [25.10.4 StatusEventType Enum System](22-dry-transformation-architecture.md#25104-statuseventtype-enum-system)
- [25.10.5 Enhanced MqttService Integration](22-dry-transformation-architecture.md#25105-enhanced-mqttservice-integration)
- [25.10.6 Usage Patterns and Best Practices](22-dry-transformation-architecture.md#25106-usage-patterns-and-best-practices)
- [25.10.6.1 Constants Approach (Recommended for Simple Cases)](22-dry-transformation-architecture.md#251061-constants-approach-recommended-for-simple-cases)
- [25.10.6.2 Enum Approach (Best for Complex Logic)](22-dry-transformation-architecture.md#251062-enum-approach-best-for-complex-logic)
- [25.10.6.3 Registry Approach (Dynamic Scenarios)](22-dry-transformation-architecture.md#251063-registry-approach-dynamic-scenarios)
- [25.10.7 System Benefits and Metrics](22-dry-transformation-architecture.md#25107-system-benefits-and-metrics)
- [25.10.7.1 Code Quality Improvements](22-dry-transformation-architecture.md#251071-code-quality-improvements)
- [25.10.7.2 Performance Characteristics](22-dry-transformation-architecture.md#251072-performance-characteristics)
- [25.10.7.3 Developer Experience Enhancements](22-dry-transformation-architecture.md#251073-developer-experience-enhancements)
- [25.10.8 Extension and Maintenance](22-dry-transformation-architecture.md#25108-extension-and-maintenance)
- [25.10.8.1 Adding New Status Types](22-dry-transformation-architecture.md#251081-adding-new-status-types)
- [25.10.8.2 Validation and Testing](22-dry-transformation-architecture.md#251082-validation-and-testing)
- [25.10.9 Architecture Decision Records](22-dry-transformation-architecture.md#25109-architecture-decision-records)
- [25.10.9.1 Why Three Approaches?](22-dry-transformation-architecture.md#251091-why-three-approaches)
- [25.10.9.2 Performance Considerations](22-dry-transformation-architecture.md#251092-performance-considerations)
- [25.10.9.3 Maintenance Strategy](22-dry-transformation-architecture.md#251093-maintenance-strategy)
- [25.11 CommandId DRY System Architecture](22-dry-transformation-architecture.md#2511-commandid-dry-system-architecture)
- [25.11.1 Comprehensive Command Management](22-dry-transformation-architecture.md#25111-comprehensive-command-management)
- [25.11.2 Blueprint Compliance](22-dry-transformation-architecture.md#25112-blueprint-compliance)
- [25.11.2.1 Zone Commands (19 total)](22-dry-transformation-architecture.md#251121-zone-commands-19-total)
- [25.11.2.2 Client Commands (6 total)](22-dry-transformation-architecture.md#251122-client-commands-6-total)
- [25.11.3 Architectural Symmetry](22-dry-transformation-architecture.md#25113-architectural-symmetry)
- [25.11.4 Implementation Benefits](22-dry-transformation-architecture.md#25114-implementation-benefits)
- [25.12 Conclusion](22-dry-transformation-architecture.md#2512-conclusion)

26. [Deployment and Operations](23-deployment-and-operations.md#26-deployment-and-operations)

- [26.1 Deployment Options](23-deployment-and-operations.md#261-deployment-options)
- [26.1.1 Docker Deployment (Recommended)](23-deployment-and-operations.md#2611-docker-deployment-recommended)
- [26.1.2 Kubernetes Deployment](23-deployment-and-operations.md#2612-kubernetes-deployment)
- [26.1.3 Bare Metal / Virtual Machine Deployment](23-deployment-and-operations.md#2613-bare-metal-virtual-machine-deployment)
- [26.2 Monitoring and Observability](23-deployment-and-operations.md#262-monitoring-and-observability)
- [26.2.1 Logging](23-deployment-and-operations.md#2621-logging)
- [26.2.2 Metrics](23-deployment-and-operations.md#2622-metrics)
- [26.2.3 Distributed Tracing](23-deployment-and-operations.md#2623-distributed-tracing)
- [26.2.4 Health Checks](23-deployment-and-operations.md#2624-health-checks)
- [26.3 Operational Procedures](23-deployment-and-operations.md#263-operational-procedures)
- [26.3.1 Deployment/Update Process (Docker Compose Example)](23-deployment-and-operations.md#2631-deploymentupdate-process-docker-compose-example)
- [26.3.2 Configuration Updates](23-deployment-and-operations.md#2632-configuration-updates)
- [26.3.3 Backup and Restore](23-deployment-and-operations.md#2633-backup-and-restore)
- [26.3.4 Troubleshooting](23-deployment-and-operations.md#2634-troubleshooting)
- [26.3.5 Scaling](23-deployment-and-operations.md#2635-scaling)
- [26.4 Security Considerations](23-deployment-and-operations.md#264-security-considerations)
- [26.4.1 Network Security](23-deployment-and-operations.md#2641-network-security)
- [26.4.2 Authentication and Authorization](23-deployment-and-operations.md#2642-authentication-and-authorization)
- [26.4.3 Secrets Management](23-deployment-and-operations.md#2643-secrets-management)

27. [Docker Infrastructure](25-docker-infrastructure.md#27-docker-infrastructure)

- [27.1 Container Architecture Overview](25-docker-infrastructure.md#271-container-architecture-overview)
- [27.2 `snapserver` Container Customization](25-docker-infrastructure.md#272-snapserver-container-customization)
- [27.3 `snapdog` Container (`/docker/snapdog/Dockerfile`)](25-docker-infrastructure.md#273-snapdog-container-dockersnapdogdockerfile)
- [27.4 Docker Compose Configuration (Production Example)](25-docker-infrastructure.md#274-docker-compose-configuration-production-example)
- [27.5 Docker Compose Profiles](25-docker-infrastructure.md#275-docker-compose-profiles)
- [27.6 Environment Variables for Production](25-docker-infrastructure.md#276-environment-variables-for-production)

28. [Appendices](30-appendices.md#28-appendices)

- [28.1 Glossary](30-appendices.md#281-glossary)
- [28.2 References](30-appendices.md#282-references)
- [28.2.1 External Systems & Libraries](30-appendices.md#2821-external-systems-libraries)
- [28.2.2 .NET & Core Libraries](30-appendices.md#2822-net-core-libraries)
- [28.2.3 Analysis & Style Tools](30-appendices.md#2823-analysis-style-tools)
- [28.2.4 Design Patterns & Principles](30-appendices.md#2824-design-patterns-principles)
- [28.3 KNX DPT Value Mapping Summary](30-appendices.md#283-knx-dpt-value-mapping-summary)
- [28.4 Error Codes Reference](30-appendices.md#284-error-codes-reference)

29. [Table of Contents](index.md#29-table-of-contents)
