...
23. [Blueprint 17: Command-Status Flow Pattern](17-command-status-flow.md#23-blueprint-17-command-status-flow-pattern)
...
24. [Testing Strategy](18-testing-strategy.md#24-testing-strategy)

- [24.1 Test Types and Goals](18-testing-strategy.md#241-test-types-and-goals)
- [24.2 Specific Component Testing Approaches](18-testing-strategy.md#242-specific-component-testing-approaches)
- [24.3 Specific Test Scenario Examples](18-testing-strategy.md#243-specific-test-scenario-examples)
- [24.4 Supporting Strategies](18-testing-strategy.md#244-supporting-strategies)

25. [Dependencies](20-dependencies.md#25-dependencies)

- [25.1 .NET Framework](20-dependencies.md#251-net-framework)
- [25.2 Core NuGet Packages](20-dependencies.md#252-core-nuget-packages)
- [25.2.1 Application Framework & Utilities](20-dependencies.md#2521-application-framework-utilities)
- [25.2.2 Resilience](20-dependencies.md#2522-resilience)
- [25.2.3 Logging](20-dependencies.md#2523-logging)
- [25.2.4 External System Integration](20-dependencies.md#2524-external-system-integration)
- [25.2.5 Observability (OpenTelemetry)](20-dependencies.md#2525-observability-opentelemetry)
- [25.2.6 Code Quality & Analysis](20-dependencies.md#2526-code-quality-analysis)
- [25.2.7 Testing Dependencies](20-dependencies.md#2527-testing-dependencies)
- [25.3 Centralized Package Management (`Directory.Packages.props`)](20-dependencies.md#253-centralized-package-management-directorypackagesprops)
- [25.4 Dependency Management Strategy](20-dependencies.md#254-dependency-management-strategy)
- [25.5 Native Dependencies](20-dependencies.md#255-native-dependencies)

26. [DRY Transformation Architecture](22-dry-transformation-architecture.md#26-dry-transformation-architecture)

- [26.1 Overview](22-dry-transformation-architecture.md#261-overview)
- [26.2 Architectural Principles](22-dry-transformation-architecture.md#262-architectural-principles)
- [26.2.1 Single Source of Truth](22-dry-transformation-architecture.md#2621-single-source-of-truth)
- [26.2.2 Type Safety](22-dry-transformation-architecture.md#2622-type-safety)
- [26.2.3 Blueprint Integration](22-dry-transformation-architecture.md#2623-blueprint-integration)
- [26.2.4 Automated Consistency Validation](22-dry-transformation-architecture.md#2624-automated-consistency-validation)
- [26.2.5 Developer Experience](22-dry-transformation-architecture.md#2625-developer-experience)
- [26.3 Attribute System Architecture](22-dry-transformation-architecture.md#263-attribute-system-architecture)
- [26.3.1 StatusIdAttribute](22-dry-transformation-architecture.md#2631-statusidattribute)
- [26.3.2 CommandAttribute](22-dry-transformation-architecture.md#2632-commandattribute)
- [26.4 Registry System Architecture](22-dry-transformation-architecture.md#264-registry-system-architecture)
- [26.4.1 StatusIdRegistry](22-dry-transformation-architecture.md#2641-statusidregistry)
- [26.4.2 CommandIdRegistry](22-dry-transformation-architecture.md#2642-commandidregistry)
- [26.5 Implementation Categories](22-dry-transformation-architecture.md#265-implementation-categories)
- [26.5.1 Status Notification System (Blueprint Compliant)](22-dry-transformation-architecture.md#2651-status-notification-system-blueprint-compliant)
- [26.5.1.1 Client Status Notifications (7 Classes)](22-dry-transformation-architecture.md#26511-client-status-notifications-7-classes)
- [26.5.1.2 Zone Status Notifications (6 Classes)](22-dry-transformation-architecture.md#26512-zone-status-notifications-6-classes)
- [26.5.1.3 Global Status Notifications (5 Classes)](22-dry-transformation-architecture.md#26513-global-status-notifications-5-classes)
- [26.5.1.4 Additional Status Notifications (3 Classes)](22-dry-transformation-architecture.md#26514-additional-status-notifications-3-classes)
- [26.5.2 Command System (Blueprint Compliant)](22-dry-transformation-architecture.md#2652-command-system-blueprint-compliant)
- [26.5.2.1 Client Commands (8 Classes)](22-dry-transformation-architecture.md#26521-client-commands-8-classes)
- [26.5.2.2 Zone Playback Commands (3 Classes)](22-dry-transformation-architecture.md#26522-zone-playback-commands-3-classes)
- [26.5.2.3 Zone Volume Commands (5 Classes)](22-dry-transformation-architecture.md#26523-zone-volume-commands-5-classes)
- [26.5.2.4 Zone Track Commands (6 Classes)](22-dry-transformation-architecture.md#26524-zone-track-commands-6-classes)
- [26.5.2.5 Zone Playlist Commands (7 Classes)](22-dry-transformation-architecture.md#26525-zone-playlist-commands-7-classes)
- [26.5.2.6 Additional Commands (3 Classes)](22-dry-transformation-architecture.md#26526-additional-commands-3-classes)
- [26.6 Automated Consistency Validation](22-dry-transformation-architecture.md#266-automated-consistency-validation)
- [26.6.1 Comprehensive Test Suite](22-dry-transformation-architecture.md#2661-comprehensive-test-suite)
- [26.6.1.1 Command Framework Consistency Tests](22-dry-transformation-architecture.md#26611-command-framework-consistency-tests)
- [26.6.1.2 Cross-Protocol Consistency Tests](22-dry-transformation-architecture.md#26612-cross-protocol-consistency-tests)
- [26.6.2 Reverse-Direction Testing](22-dry-transformation-architecture.md#2662-reverse-direction-testing)
- [26.6.3 Obsolete Implementation Detection](22-dry-transformation-architecture.md#2663-obsolete-implementation-detection)
- [26.6.4 Blueprint Compliance Validation](22-dry-transformation-architecture.md#2664-blueprint-compliance-validation)
- [26.7 Integration Patterns](22-dry-transformation-architecture.md#267-integration-patterns)
- [26.7.1 Notification Handler Pattern](22-dry-transformation-architecture.md#2671-notification-handler-pattern)
- [26.7.2 Command Processing Pattern](22-dry-transformation-architecture.md#2672-command-processing-pattern)
- [26.7.3 Status Factory Pattern](22-dry-transformation-architecture.md#2673-status-factory-pattern)
- [26.8 Quality Assurance and Metrics](22-dry-transformation-architecture.md#268-quality-assurance-and-metrics)
- [26.8.1 Compile-Time Validation](22-dry-transformation-architecture.md#2681-compile-time-validation)
- [26.8.2 Runtime Validation](22-dry-transformation-architecture.md#2682-runtime-validation)
- [26.8.3 Architectural Cleanup Results](22-dry-transformation-architecture.md#2683-architectural-cleanup-results)
- [26.8.4 Code Quality Metrics](22-dry-transformation-architecture.md#2684-code-quality-metrics)
- [26.8.5 Performance Characteristics](22-dry-transformation-architecture.md#2685-performance-characteristics)
- [26.9 Future Extensibility](22-dry-transformation-architecture.md#269-future-extensibility)
- [26.9.1 Adding New Notifications](22-dry-transformation-architecture.md#2691-adding-new-notifications)
- [26.9.2 Adding New Commands](22-dry-transformation-architecture.md#2692-adding-new-commands)
- [26.9.3 Automatic Integration](22-dry-transformation-architecture.md#2693-automatic-integration)
- [26.10 Conclusion](22-dry-transformation-architecture.md#2610-conclusion)
- [26.10.1 Architectural Excellence](22-dry-transformation-architecture.md#26101-architectural-excellence)
- [26.10.2 Developer Experience](22-dry-transformation-architecture.md#26102-developer-experience)
- [26.10.3 Quality Metrics](22-dry-transformation-architecture.md#26103-quality-metrics)
- [26.10.4 Architectural Impact](22-dry-transformation-architecture.md#26104-architectural-impact)

27. [a. Fluent Blueprint-as-Code](22a-fluent-blueprint-as-code.md#27-a-fluent-blueprint-as-code)

- [27.1 Overview](22a-fluent-blueprint-as-code.md#271-overview)
- [27.2 Problem](22a-fluent-blueprint-as-code.md#272-problem)
- [27.3 Solution: Fluent Blueprint DSL](22a-fluent-blueprint-as-code.md#273-solution-fluent-blueprint-dsl)
- [27.3.1 Core Example](22a-fluent-blueprint-as-code.md#2731-core-example)
- [27.4 DSL API](22a-fluent-blueprint-as-code.md#274-dsl-api)
- [27.4.1 Fluent Chain Structure](22a-fluent-blueprint-as-code.md#2741-fluent-chain-structure)
- [27.4.2 Methods](22a-fluent-blueprint-as-code.md#2742-methods)
- [27.5 Design Principles](22a-fluent-blueprint-as-code.md#275-design-principles)
- [27.5.1 Explicit Inclusion](22a-fluent-blueprint-as-code.md#2751-explicit-inclusion)
- [27.5.2 Explicit Exclusion for Clarity](22a-fluent-blueprint-as-code.md#2752-explicit-exclusion-for-clarity)
- [27.5.3 Required by Default](22a-fluent-blueprint-as-code.md#2753-required-by-default)
- [27.6 Usage in Tests](22a-fluent-blueprint-as-code.md#276-usage-in-tests)
- [27.6.1 Automatic Validation](22a-fluent-blueprint-as-code.md#2761-automatic-validation)
- [27.6.2 Query API](22a-fluent-blueprint-as-code.md#2762-query-api)
- [27.7 Benefits](22a-fluent-blueprint-as-code.md#277-benefits)
- [27.8 Benefits](22a-fluent-blueprint-as-code.md#278-benefits)
- [27.9 Implementation Strategy](22a-fluent-blueprint-as-code.md#279-implementation-strategy)
- [27.10 Future Extensions](22a-fluent-blueprint-as-code.md#2710-future-extensions)

28. [Deployment and Operations](23-deployment-and-operations.md#28-deployment-and-operations)

- [28.1 Deployment Options](23-deployment-and-operations.md#281-deployment-options)
- [28.1.1 Docker Deployment (Recommended)](23-deployment-and-operations.md#2811-docker-deployment-recommended)
- [28.1.2 Kubernetes Deployment](23-deployment-and-operations.md#2812-kubernetes-deployment)
- [28.1.3 Bare Metal / Virtual Machine Deployment](23-deployment-and-operations.md#2813-bare-metal-virtual-machine-deployment)
- [28.2 Monitoring and Observability](23-deployment-and-operations.md#282-monitoring-and-observability)
- [28.2.1 Logging](23-deployment-and-operations.md#2821-logging)
- [28.2.2 Metrics](23-deployment-and-operations.md#2822-metrics)
- [28.2.3 Distributed Tracing](23-deployment-and-operations.md#2823-distributed-tracing)
- [28.2.4 Health Checks](23-deployment-and-operations.md#2824-health-checks)
- [28.3 Operational Procedures](23-deployment-and-operations.md#283-operational-procedures)
- [28.3.1 Deployment/Update Process (Docker Compose Example)](23-deployment-and-operations.md#2831-deploymentupdate-process-docker-compose-example)
- [28.3.2 Configuration Updates](23-deployment-and-operations.md#2832-configuration-updates)
- [28.3.3 Backup and Restore](23-deployment-and-operations.md#2833-backup-and-restore)
- [28.3.4 Troubleshooting](23-deployment-and-operations.md#2834-troubleshooting)
- [28.3.5 Scaling](23-deployment-and-operations.md#2835-scaling)
- [28.4 Security Considerations](23-deployment-and-operations.md#284-security-considerations)
- [28.4.1 Network Security](23-deployment-and-operations.md#2841-network-security)
- [28.4.2 Authentication and Authorization](23-deployment-and-operations.md#2842-authentication-and-authorization)
- [28.4.3 Secrets Management](23-deployment-and-operations.md#2843-secrets-management)

29. [Docker Infrastructure](25-docker-infrastructure.md#29-docker-infrastructure)

- [29.1 Container Architecture Overview](25-docker-infrastructure.md#291-container-architecture-overview)
- [29.2 `snapserver` Container Customization](25-docker-infrastructure.md#292-snapserver-container-customization)
- [29.3 `snapdog` Container (`/docker/snapdog/Dockerfile`)](25-docker-infrastructure.md#293-snapdog-container-dockersnapdogdockerfile)
- [29.4 Docker Compose Configuration (Production Example)](25-docker-infrastructure.md#294-docker-compose-configuration-production-example)
- [29.5 Docker Compose Profiles](25-docker-infrastructure.md#295-docker-compose-profiles)
- [29.6 Environment Variables for Production](25-docker-infrastructure.md#296-environment-variables-for-production)

30. [Appendices](30-appendices.md#30-appendices)

- [30.1 Glossary](30-appendices.md#301-glossary)
- [30.2 References](30-appendices.md#302-references)
- [30.2.1 External Systems & Libraries](30-appendices.md#3021-external-systems-libraries)
- [30.2.2 .NET & Core Libraries](30-appendices.md#3022-net-core-libraries)
- [30.2.3 Analysis & Style Tools](30-appendices.md#3023-analysis-style-tools)
- [30.2.4 Design Patterns & Principles](30-appendices.md#3024-design-patterns-principles)
- [30.3 KNX DPT Value Mapping Summary](30-appendices.md#303-knx-dpt-value-mapping-summary)
- [30.4 Error Codes Reference](30-appendices.md#304-error-codes-reference)

31. [Table of Contents](index.md#31-table-of-contents)
