...
- [11.1 SignalR Design Philosophy](11a-signalr.md#111-signalr-design-philosophy)
- [11.2 Connection and Authentication](11a-signalr.md#112-connection-and-authentication)
- [11.3 Event Categories](11a-signalr.md#113-event-categories)
- [11.3.1 Zone Events](11a-signalr.md#1131-zone-events)
- [11.3.2 Client Events](11a-signalr.md#1132-client-events)
- [11.3.3 System Events](11a-signalr.md#1133-system-events)
- [11.4 SignalR Event Specification](11a-signalr.md#114-signalr-event-specification)
...
- [11.5 Event Exclusions](11a-signalr.md#115-event-exclusions)
- [11.5.1 Static Configuration Data](11a-signalr.md#1151-static-configuration-data)
- [11.5.2 Bulk Data Collections](11a-signalr.md#1152-bulk-data-collections)
- [11.5.3 Alternative Notification Paths](11a-signalr.md#1153-alternative-notification-paths)
- [11.5.4 Media Browsing Data](11a-signalr.md#1154-media-browsing-data)
- [11.6 Implementation Architecture](11a-signalr.md#116-implementation-architecture)
- [11.6.1 Hub Structure](11a-signalr.md#1161-hub-structure)
- [11.6.2 Event Broadcasting](11a-signalr.md#1162-event-broadcasting)
- [11.6.3 Notification Integration](11a-signalr.md#1163-notification-integration)
- [11.7 Client Implementation Examples](11a-signalr.md#117-client-implementation-examples)
- [11.7.1 JavaScript/TypeScript](11a-signalr.md#1171-javascripttypescript)
- [11.7.2 C# Client](11a-signalr.md#1172-c-client)
- [11.8 Performance Considerations](11a-signalr.md#118-performance-considerations)
- [11.8.1 Event Frequency](11a-signalr.md#1181-event-frequency)
- [11.8.2 Bandwidth Optimization](11a-signalr.md#1182-bandwidth-optimization)
- [11.8.3 Connection Management](11a-signalr.md#1183-connection-management)
- [11.9 Error Handling](11a-signalr.md#119-error-handling)
- [11.9.1 Connection Errors](11a-signalr.md#1191-connection-errors)
- [11.9.2 Event Delivery](11a-signalr.md#1192-event-delivery)
- [11.10 Future Enhancements](11a-signalr.md#1110-future-enhancements)
- [11.10.1 Selective Subscriptions](11a-signalr.md#11101-selective-subscriptions)
- [11.10.2 Event History](11a-signalr.md#11102-event-history)
- [11.10.3 Bidirectional Commands](11a-signalr.md#11103-bidirectional-commands)
...
- [13.2 Configuration](13-metrics-and-telemetry-infrastructure-layer.md#132-configuration)
- [13.2.1 Environment Variables](13-metrics-and-telemetry-infrastructure-layer.md#1321-environment-variables)
- [13.2.2 Backend-Specific Examples](13-metrics-and-telemetry-infrastructure-layer.md#1322-backend-specific-examples)
- [13.3 Implementation](13-metrics-and-telemetry-infrastructure-layer.md#133-implementation)
- [13.3.1 TelemetryConfig Class](13-metrics-and-telemetry-infrastructure-layer.md#1331-telemetryconfig-class)
- [13.3.2 OpenTelemetry Setup](13-metrics-and-telemetry-infrastructure-layer.md#1332-opentelemetry-setup)
- [13.4 Scope](13-metrics-and-telemetry-infrastructure-layer.md#134-scope)
- [13.5 Telemetry Types](13-metrics-and-telemetry-infrastructure-layer.md#135-telemetry-types)
- [13.5.1 Traces](13-metrics-and-telemetry-infrastructure-layer.md#1351-traces)
- [13.5.2 Metrics](13-metrics-and-telemetry-infrastructure-layer.md#1352-metrics)
- [13.5.3 Logs](13-metrics-and-telemetry-infrastructure-layer.md#1353-logs)
- [13.6 Benefits](13-metrics-and-telemetry-infrastructure-layer.md#136-benefits)
- [13.6.1 Vendor Neutrality](13-metrics-and-telemetry-infrastructure-layer.md#1361-vendor-neutrality)
- [13.6.2 Operational Benefits](13-metrics-and-telemetry-infrastructure-layer.md#1362-operational-benefits)
- [13.6.3 Development Experience](13-metrics-and-telemetry-infrastructure-layer.md#1363-development-experience)
- [13.7 OpenTelemetry Setup (DI / `/Worker/DI/ObservabilityExtensions.cs`)](13-metrics-and-telemetry-infrastructure-layer.md#137-opentelemetry-setup-di-workerdiobservabilityextensionscs)
- [13.8 Custom Metrics (`IMetricsService` / `OpenTelemetryMetricsService`)](13-metrics-and-telemetry-infrastructure-layer.md#138-custom-metrics-imetricsservice-opentelemetrymetricsservice)
- [13.9 Manual Tracing Instrumentation](13-metrics-and-telemetry-infrastructure-layer.md#139-manual-tracing-instrumentation)
- [13.10 Logging Correlation](13-metrics-and-telemetry-infrastructure-layer.md#1310-logging-correlation)
...
25. [SnapDog2 Web UI – Architecture & Implementation Blueprint (v3, English)](17a-webgui.md#25-snapdog2-web-ui-architecture-implementation-blueprint-v3-english)

- [25.1 Product Goals & Principles](17a-webgui.md#251-product-goals-principles)
- [25.2 Technology Stack & Packaging](17a-webgui.md#252-technology-stack-packaging)
- [25.3 Visual Design & Typography](17a-webgui.md#253-visual-design-typography)
- [25.3.1 UI Layout Structure](17a-webgui.md#2531-ui-layout-structure)
- [25.3.1.1 Main Interface Layout (`/`)](17a-webgui.md#25311-main-interface-layout)
- [25.3.1.2 Zone Section Components](17a-webgui.md#25312-zone-section-components)
- [25.3.1.3 Additional Endpoints](17a-webgui.md#25313-additional-endpoints)
- [25.3.2 Technical Implementation Details](17a-webgui.md#2532-technical-implementation-details)
- [25.3.2.1 Drag-and-Drop Client Assignment](17a-webgui.md#25321-drag-and-drop-client-assignment)
- [25.3.2.2 Data Fetching Strategy](17a-webgui.md#25322-data-fetching-strategy)
- [25.3.3 Typography Foundation](17a-webgui.md#2533-typography-foundation)
- [25.3.3.1 Primary Font: Orbitron](17a-webgui.md#25331-primary-font-orbitron)
- [25.3.3.2 Secondary Font: System Font Stack](17a-webgui.md#25332-secondary-font-system-font-stack)
- [25.3.4 Design Language](17a-webgui.md#2534-design-language)
- [25.3.4.1 Theme: Modern Audio Control Interface](17a-webgui.md#25341-theme-modern-audio-control-interface)
- [25.3.4.2 Component Styling Principles](17a-webgui.md#25342-component-styling-principles)
- [25.3.5 Color Palette & Dark/Light Mode](17a-webgui.md#2535-color-palette-darklight-mode)
- [25.3.5.1 Light Mode](17a-webgui.md#25351-light-mode)
- [25.4 Dark Mode](17a-webgui.md#254-dark-mode)
- [25.5 Semantic Colors](17a-webgui.md#255-semantic-colors)
- [25.6 Typography Scale](17a-webgui.md#256-typography-scale)
- [25.7 Component Visual Guidelines](17a-webgui.md#257-component-visual-guidelines)
- [25.8 Zone Cards](17a-webgui.md#258-zone-cards)
- [25.9 Client Management](17a-webgui.md#259-client-management)
- [25.10 Navigation & Controls](17a-webgui.md#2510-navigation-controls)
- [25.11 Solution Layout](17a-webgui.md#2511-solution-layout)
- [25.12 Integration into Monolith (/SnapDog2)](17a-webgui.md#2512-integration-into-monolith-snapdog2)
- [25.12.1 Project References](17a-webgui.md#25121-project-references)
- [25.12.2 Program.cs (Host)](17a-webgui.md#25122-programcs-host)
- [25.12.3 SnapDog2.WebUi.Assets.csproj](17a-webgui.md#25123-snapdog2webuiassetscsproj)
- [25.13 Tests](17a-webgui.md#2513-tests)
- [25.14 Advantages of Project Split](17a-webgui.md#2514-advantages-of-project-split)
- [25.15 Folder Reality & Quickstart](17a-webgui.md#2515-folder-reality-quickstart)
- [25.15.1 Quickstart](17a-webgui.md#25151-quickstart)
- [25.16 Next Steps](17a-webgui.md#2516-next-steps)
- [25.17 Implementation Guide](17a-webgui.md#2517-implementation-guide)
- [25.18 Project Creation Commands (Exact Sequence)](17a-webgui.md#2518-project-creation-commands-exact-sequence)
- [25.19 Exact Project File Contents](17a-webgui.md#2519-exact-project-file-contents)
- [25.20 Required File Structure and Contents](17a-webgui.md#2520-required-file-structure-and-contents)
- [25.21 Core Component Skeletons](17a-webgui.md#2521-core-component-skeletons)
- [25.22 API Client Integration Pattern](17a-webgui.md#2522-api-client-integration-pattern)
- [25.23 Program.cs Integration](17a-webgui.md#2523-programcs-integration)
- [25.24 Build and Validation Steps](17a-webgui.md#2524-build-and-validation-steps)
- [25.25 Implementation Success Factors](17a-webgui.md#2525-implementation-success-factors)
- [25.25.1 Requirements for AI Success](17a-webgui.md#25251-requirements-for-ai-success)
- [25.25.2 Common Implementation Failures](17a-webgui.md#25252-common-implementation-failures)
- [25.25.3 Implementation Validation](17a-webgui.md#25253-implementation-validation)
- [25.26 Blueprint Completion](17a-webgui.md#2526-blueprint-completion)
