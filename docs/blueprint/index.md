...
23. [DRY Transformation Architecture](22-dry-transformation-architecture.md#23-dry-transformation-architecture)

- [23.1 Overview](22-dry-transformation-architecture.md#231-overview)
- [23.2 Architectural Principles](22-dry-transformation-architecture.md#232-architectural-principles)
- [23.2.1 Single Source of Truth](22-dry-transformation-architecture.md#2321-single-source-of-truth)
- [23.2.2 Type Safety](22-dry-transformation-architecture.md#2322-type-safety)
- [23.2.3 Blueprint Integration](22-dry-transformation-architecture.md#2323-blueprint-integration)
- [23.2.4 Developer Experience](22-dry-transformation-architecture.md#2324-developer-experience)
- [23.3 Attribute System Architecture](22-dry-transformation-architecture.md#233-attribute-system-architecture)
- [23.3.1 StatusIdAttribute](22-dry-transformation-architecture.md#2331-statusidattribute)
- [23.3.2 CommandIdAttribute](22-dry-transformation-architecture.md#2332-commandidattribute)
- [23.4 Implementation Categories](22-dry-transformation-architecture.md#234-implementation-categories)
- [23.4.1 Notification System (19 Classes)](22-dry-transformation-architecture.md#2341-notification-system-19-classes)
- [23.4.1.1 Client Notifications (6 Classes)](22-dry-transformation-architecture.md#23411-client-notifications-6-classes)
- [23.4.1.2 Zone Notifications (8 Classes)](22-dry-transformation-architecture.md#23412-zone-notifications-8-classes)
- [23.4.1.3 Global Notifications (4 Classes)](22-dry-transformation-architecture.md#23413-global-notifications-4-classes)
- [23.4.1.4 Generic Infrastructure (1 Class)](22-dry-transformation-architecture.md#23414-generic-infrastructure-1-class)
- [23.4.2 Command System (22 Classes)](22-dry-transformation-architecture.md#2342-command-system-22-classes)
- [23.4.2.1 Client Commands (3 Classes)](22-dry-transformation-architecture.md#23421-client-commands-3-classes)
- [23.4.2.2 Zone Playback Commands (3 Classes)](22-dry-transformation-architecture.md#23422-zone-playback-commands-3-classes)
- [23.4.2.3 Zone Volume Commands (4 Classes)](22-dry-transformation-architecture.md#23423-zone-volume-commands-4-classes)
- [23.4.2.4 Zone Track Commands (5 Classes)](22-dry-transformation-architecture.md#23424-zone-track-commands-5-classes)
- [23.4.2.5 Zone Playlist Commands (7 Classes)](22-dry-transformation-architecture.md#23425-zone-playlist-commands-7-classes)
- [23.5 Integration Patterns](22-dry-transformation-architecture.md#235-integration-patterns)
- [23.5.1 Notification Handler Pattern](22-dry-transformation-architecture.md#2351-notification-handler-pattern)
- [23.5.2 Command Processing Pattern](22-dry-transformation-architecture.md#2352-command-processing-pattern)
- [23.6 Quality Assurance](22-dry-transformation-architecture.md#236-quality-assurance)
- [23.6.1 Compile-Time Validation](22-dry-transformation-architecture.md#2361-compile-time-validation)
- [23.6.2 Runtime Validation](22-dry-transformation-architecture.md#2362-runtime-validation)
- [23.6.3 Refactoring Safety](22-dry-transformation-architecture.md#2363-refactoring-safety)
- [23.7 Blueprint Reference System](22-dry-transformation-architecture.md#237-blueprint-reference-system)
- [23.7.1 Reference Format](22-dry-transformation-architecture.md#2371-reference-format)
- [23.7.2 Category Mapping](22-dry-transformation-architecture.md#2372-category-mapping)
- [23.8 Benefits and Outcomes](22-dry-transformation-architecture.md#238-benefits-and-outcomes)
- [23.8.1 Code Quality Metrics](22-dry-transformation-architecture.md#2381-code-quality-metrics)
- [23.8.2 Developer Experience](22-dry-transformation-architecture.md#2382-developer-experience)
- [23.8.3 Maintainability](22-dry-transformation-architecture.md#2383-maintainability)
- [23.9 Future Extensibility](22-dry-transformation-architecture.md#239-future-extensibility)
- [23.9.1 Adding New Notifications](22-dry-transformation-architecture.md#2391-adding-new-notifications)
- [23.9.2 Adding New Commands](22-dry-transformation-architecture.md#2392-adding-new-commands)
- [23.9.3 Validation Enhancements](22-dry-transformation-architecture.md#2393-validation-enhancements)
- [23.10 Enhanced StatusId System Architecture](22-dry-transformation-architecture.md#2310-enhanced-statusid-system-architecture)
- [23.10.1 Multi-Layered DRY Approach](22-dry-transformation-architecture.md#23101-multi-layered-dry-approach)
- [23.10.2 StatusIdRegistry Implementation](22-dry-transformation-architecture.md#23102-statusidregistry-implementation)
- [23.10.3 StatusIds Constants Class](22-dry-transformation-architecture.md#23103-statusids-constants-class)
- [23.10.4 StatusEventType Enum System](22-dry-transformation-architecture.md#23104-statuseventtype-enum-system)
- [23.10.5 Enhanced MqttService Integration](22-dry-transformation-architecture.md#23105-enhanced-mqttservice-integration)
- [23.10.6 Usage Patterns and Best Practices](22-dry-transformation-architecture.md#23106-usage-patterns-and-best-practices)
- [23.10.6.1 Constants Approach (Recommended for Simple Cases)](22-dry-transformation-architecture.md#231061-constants-approach-recommended-for-simple-cases)
- [23.10.6.2 Enum Approach (Best for Complex Logic)](22-dry-transformation-architecture.md#231062-enum-approach-best-for-complex-logic)
- [23.10.6.3 Registry Approach (Dynamic Scenarios)](22-dry-transformation-architecture.md#231063-registry-approach-dynamic-scenarios)
- [23.10.7 System Benefits and Metrics](22-dry-transformation-architecture.md#23107-system-benefits-and-metrics)
- [23.10.7.1 Code Quality Improvements](22-dry-transformation-architecture.md#231071-code-quality-improvements)
- [23.10.7.2 Performance Characteristics](22-dry-transformation-architecture.md#231072-performance-characteristics)
- [23.10.7.3 Developer Experience Enhancements](22-dry-transformation-architecture.md#231073-developer-experience-enhancements)
- [23.10.8 Extension and Maintenance](22-dry-transformation-architecture.md#23108-extension-and-maintenance)
- [23.10.8.1 Adding New Status Types](22-dry-transformation-architecture.md#231081-adding-new-status-types)
- [23.10.8.2 Validation and Testing](22-dry-transformation-architecture.md#231082-validation-and-testing)
- [23.10.9 Architecture Decision Records](22-dry-transformation-architecture.md#23109-architecture-decision-records)
- [23.10.9.1 Why Three Approaches?](22-dry-transformation-architecture.md#231091-why-three-approaches)
- [23.10.9.2 Performance Considerations](22-dry-transformation-architecture.md#231092-performance-considerations)
- [23.10.9.3 Maintenance Strategy](22-dry-transformation-architecture.md#231093-maintenance-strategy)
- [23.11 CommandId DRY System Architecture](22-dry-transformation-architecture.md#2311-commandid-dry-system-architecture)
- [23.11.1 Comprehensive Command Management](22-dry-transformation-architecture.md#23111-comprehensive-command-management)
- [23.11.2 Blueprint Compliance](22-dry-transformation-architecture.md#23112-blueprint-compliance)
- [23.11.2.1 Zone Commands (19 total)](22-dry-transformation-architecture.md#231121-zone-commands-19-total)
- [23.11.2.2 Client Commands (6 total)](22-dry-transformation-architecture.md#231122-client-commands-6-total)
- [23.11.3 Architectural Symmetry](22-dry-transformation-architecture.md#23113-architectural-symmetry)
- [23.11.4 Implementation Benefits](22-dry-transformation-architecture.md#23114-implementation-benefits)
- [23.12 Conclusion](22-dry-transformation-architecture.md#2312-conclusion)
