# 13. Zone-to-Client Mapping Strategy (Server Layer)
...
### 13.3.1. `ZoneManager` (/Server/Managers/ZoneManager.cs)
...
## 13.4. Cortex.Mediator Notifications for Synchronization
