# 12. Zone-to-Client Mapping Strategy (Server Layer)
...
## 12.3. Implementation (`ZoneManager`, `ClientManager`, `SnapcastService`)
...
### 12.3.1. `ZoneManager` (/Server/Managers/ZoneManager.cs)
...
### 12.3.2. `ClientManager` (/Server/Managers/ClientManager.cs)
...
### 12.3.3. `SnapcastService` (/Infrastructure/Snapcast/SnapcastService.cs)
...
## 12.4. Cortex.Mediator Notifications for Synchronization
