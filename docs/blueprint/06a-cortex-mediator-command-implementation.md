# 7. Cortex.Mediator Command Framework Implementation
...
## 7.3. Base Interfaces and Common Types

### 7.3.1. Command Result Types
...
## 7.4. Global Commands and Queries

### 7.4.1. Global Status Queries
...
### 7.5.1. Playback Control Commands
...
## 7.6. Status Notifications

### 7.6.1. Global Status Notifications
...
## 7.7. Command Validators

### 7.7.1. Zone Command Validators
