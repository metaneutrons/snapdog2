...
| `POST` | `/zones/{zoneIndex}/play/track/{trackIndex}` | `TRACK_PLAY_INDEX`      | Play specific track by index         | Path: `{zoneIndex}`, `{trackIndex}` (1-based)  | No content                           | 204 No Content|
| `POST` | `/zones/{zoneIndex}/play/url`              | `TRACK_PLAY_URL`          | Play direct URL stream               | Path: `{zoneIndex}`; Body: `string` (URL)      | No content                           | 204 No Content|
...
| `GET`  | `/zones/{zoneIndex}/track/title`           | `TRACK_INFO_TITLE`        | Get current track title              | Path: `{zoneIndex}`                             | `string` (track title)               | 200 OK      |
| `GET`  | `/zones/{zoneIndex}/track/artist`          | `TRACK_INFO_ARTIST`       | Get current track artist             | Path: `{zoneIndex}`                             | `string` (track artist)              | 200 OK      |
| `GET`  | `/zones/{zoneIndex}/track/album`           | `TRACK_INFO_ALBUM`        | Get current track album              | Path: `{zoneIndex}`                             | `string` (track album)               | 200 OK      |
| `GET`  | `/zones/{zoneIndex}/track/duration`        | `TRACK_INFO_LENGTH`       | Get current track duration           | Path: `{zoneIndex}`                             | `long` (duration in ms)              | 200 OK      |
| `GET`  | `/zones/{zoneIndex}/track/position`        | `TRACK_INFO_POSITION`     | Get current track position           | Path: `{zoneIndex}`                             | `long` (position in ms)              | 200 OK      |
...
| `GET`  | `/zones/{zoneIndex}/track/cover`           | `TRACK_META_COVER`        | Get current track cover art URL      | Path: `{zoneIndex}`                             | `string` (cover URL)                 | 200 OK      |
