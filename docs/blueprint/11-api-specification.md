...
### 16.3.4. Media Management Endpoints
...
## 16.4. Request and Response Format

### 16.4.1. Standard Response Wrapper (`ApiResponse<T>`)
...
## 16.6. Pagination, Filtering, and Sorting
...
## 16.7. Webhooks and Event Streams (Optional / Future)
...
## 16.11. API Documentation (Swagger/OpenAPI)
